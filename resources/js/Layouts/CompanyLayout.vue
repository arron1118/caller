    ...
    <el-container class="layout-container-demo" ref="home">
        <el-aside class="h-screen">
            <el-menu
                ...
                class="el-menu-vertical-demo h-screen w-full text-white"
                style="width: 300px;"
            >
                <div class="bg-black text-center py-1 mb-4">
                    <el-image class="h-12" src="../../img/logo1.png" fit="contain"/>
                </div>
                <el-menu-item :route="{ path: '/admin/dashboard' }" class="p-4">
                    <el-icon>
                        <odometer/>
                    </el-icon>
                    <span>控制台</span>
                ...
                <el-menu-item>
                    <Link :href="route('/admin/user')" class="w-full"
                          :class="{'text-blue-300': route().current('/admin/user')}">
                        <el-icon>
                            <user/>
                        </el-icon>
                        <span>用户管理</span>
